...
var taskInput=document.getElementById("task-list__button-new-task");//Add a new task.
var addButton=document.getElementById("task-list__button-add"); // "Add" button
var incompleteTaskHolder=document.getElementById("task-list-incomplete");//ul of #incompleteTasks
var completedTasksHolder=document.getElementById("task-list-complete");//completed-tasks
...
var createNewTaskElement=function(taskString){
    ...
    deleteButtonImg.className='task-list__button-delete-image';
